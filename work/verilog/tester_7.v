...
module tester_7 (
  ...
  sixteen_bit_adder_1 adderCMPEQ (
    .x(M_adderCMPEQ_x),
    .y(M_adderCMPEQ_y),
  ...
  sixteen_bit_adder_1 adderCMPLT (
    .x(M_adderCMPLT_x),
    .y(M_adderCMPLT_y),
  ...
  sixteen_bit_adder_1 adderCMPLE (
    .x(M_adderCMPLE_x),
    .y(M_adderCMPLE_y),
